...
public class DataBinderMapper {
    public ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, View view,
                                         int layoutId) {
        return null;
    }
    ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, View[] view, int layoutId) {
        return null;
    }
